...
|--------|------|------|-------|-----------|------|
| M1 | ✅ 已确认 2026-08-19 | ✅ 已确认 2026-08-24 | ✅ 已确认 2026-08-24 | ✅ 完成 2026-08-26 | T0~T24 全部实现并验证；采集 26 类（泛AI）；CN 范围约束、linker 证据幂等修复；防护网齐备：六项不变量巡检 + 全管线双跑幂等测试 + 每日备份 + 一键启动（111 测试） |
| M2 | ✅ 已确认 2026-08-26 | ✅ 已确认 2026-08-27 | ✅ 已确认 2026-08-27（R1–R5） | ⏳ 进行中 | T0~T14 完成（213 测试）：B0 模型/配置/巡检 + B1 学术传承链（NISL/IPADS 实跑过 AC-1/2/9）+ B2 项目合作链（3 源实跑入库 25 条）+ B3 API 扩展与前端（rel_types 筛选/混合证据面板/学者职位主页，开发服走查通过）；下一步 T15 防护网扩展 |
| M3 | — | — | — | — | 未开始 |
| M4 | — | — | — | — | 未开始 |

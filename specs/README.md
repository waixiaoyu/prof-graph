...
| M2 | ✅ 已确认 2026-08-26 | ✅ 已确认 2026-08-27 | ✅ 已确认 2026-08-27（R1–R5） | ⏳ 进行中 | T0~T12 完成（209 测试）：B0 模型/配置/巡检 + B1 学术传承链（NISL/IPADS 实跑过 AC-1/2/9）+ B2 项目合作链（3 源实跑入库 25 条，当前均为无信号产品类新闻）；下一步 T13 API 扩展 |
| M3 | — | — | — | — | 未开始 |
| M4 | — | — | — | — | 未开始 |

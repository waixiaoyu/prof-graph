...
| M3 | ⏳ 起草待确认 | — | — | — | Specify 进行中：spec 草案 2026-08-30/31（两方法 common_network / research_similarity——spatiotemporal 经探针实证+用户确认移出待数据复盘，宪法 §3.1 同步修订；独立表全量重算零 token，RD-1~RD-11） |
| M4 | — | — | — | — | 未开始 |
